...
> Mulyankan is a decision-support tool, not an autonomous proposal selector. The bundled ML model uses brochure-derived weak supervision because historical expert-labelled MoC/CMPDI decisions were not available to the project.
